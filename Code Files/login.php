...
<div class="userform">
    <form action="checkUser.php" id="login" method="post">
        <input type="hidden" name="profile" value="<?php echo $profile; ?>" />
        <h1>Login to BuzzWizz</h1>
        <div class="form-field">
            ...
            <p>If you don't have any account then <a href="signup.php?profile=<?php echo $profile; ?>">Click here</a> to Register.</p>
        </div>
    </form>
</div>
</body>
